...
Aurora PostgreSQL, private DMS, and a Docker/SSM runner. It does not provision EKS
...
The runner has outbound internet access but no inbound rules. Aurora endpoints
...
Aurora parameter support, the DMS IAM policies and PostgreSQL parameter grant,
