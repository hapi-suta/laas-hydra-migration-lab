...
Use a small dedicated incident rehearsal before the full-size timed run. The instructor stops the DMS task from the console while the source workload continues briefly within the binlog retention window.
