...
| Connection timeout | Source SG, runner SG, subnet routes, writer endpoint | Repair the specific route or rule from Module 02. Retest TLS before importing. |
| Access denied | Client username and password, grants from Module 02 | Correct the private client file. Use the schema owner, not dms_repl. |
...
using [Module 02's MySQL connection](../02-aws/application.md#4-connect-to-the-source-using-its-managed-administrator-password).
