...
def main():
    ...
    for p in pages:
        ...
        nav = f'<a class="home" href="{prefix}index.html">The project</a><a class="home" href="{prefix}start.html">Start here: Mac setup</a>'
